...
THREEx.Planets.baseURL	= 'js/Universe/'
...
THREEx.Planets.createEarthCloud	= function(){
	...
	var geometry	= new THREE.SphereGeometry(defaultRadius+0.01, 32, 32)
	var material	= new THREE.MeshPhongMaterial({
...
THREEx.Planets.createSaturnRing	= function(){
	...
	var geometry	= new THREEx.Planets._RingGeometry(defaultRadius+0.05, 0.75, 64);
	var material	= new THREE.MeshPhongMaterial({
		map		: new THREE.Texture(canvasResult),
